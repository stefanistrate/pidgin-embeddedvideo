...
WebsiteInfo trilulilu_video = {
    ...
    "<object width=\"425\" height=\"344\">"
        "<param name=\"movie\" value=\"http://embed.trilulilu.ro/video/%VIDEO_ID%/0xe9eff4.swf\"></param>"
        "<param name=\"allowFullScreen\" value=\"true\"></param>"
        "<param name=\"allowscriptaccess\" value=\"always\"></param>"
        "<embed src=\"http://embed.trilulilu.ro/video/%VIDEO_ID%/0xe9eff4.swf\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" width=\"425\" height=\"344\"></embed>"
        "</object>",
    &check
};
