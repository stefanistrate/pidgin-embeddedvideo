...
WebsiteInfo trilulilu_image = {
    ...
    "<object width=\"448\" height=\"336\">"
        ...
        "<embed src=\"http://embed.trilulilu.ro/image/%VIDEO_ID%.swf\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" width=\"448\" height=\"386\"></embed>"
        "</object>",
    &check
};
