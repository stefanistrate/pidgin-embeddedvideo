...
WebsiteInfo yahoo_video = {
    ...
    "<object width=\"425\" height=\"320\">"
        ...
        "<embed src=\"http://d.yimg.com/static.video.yahoo.com/yep/YV_YEP.swf?ver=2.2.46\" type=\"application/x-shockwave-flash\" width=\"425\" height=\"320\" allowFullScreen=\"true\" AllowScriptAccess=\"always\" bgcolor=\"#000000\" flashVars=\"id=%MISC1%&vid=%VIDEO_ID%&intl=us&embed=1\" ></embed>"
        "</object>",
    NULL
};
